...
export const getCheaperMobileAlternativeQuery =
  "SELECT * FROM Subscriptions WHERE type = $1 AND priceMonth <= $2 AND datamonth >= $3 AND talktime >= $4 AND subscriptionId <> $5 ORDER BY priceMonth ASC, datamonth DESC LIMIT 3;";
